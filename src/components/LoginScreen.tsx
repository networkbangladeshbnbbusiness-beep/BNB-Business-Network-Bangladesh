...
export default function LoginScreen({ 
  ...
  const handleVerifyAndLogin = async (pinValue: string) => {
    ...
    if (isCurrentlyActiveOnOtherDevice) {
      setError('এই অ্যাকাউন্টটি বর্তমানে অন্য একটি ডিভাইসে সক্রিয়ভাবে লগইন রয়েছে! একই সাথে দুটি ডিভাইসে লগইন করা যাবে না। অন্য ডিভাইসে ব্যবহার করতে হলে আগের ডিভাইস থেকে অবশ্যই "লগ আউট" করতে হবে।');
      setLoginPin('');
      return;
    }
